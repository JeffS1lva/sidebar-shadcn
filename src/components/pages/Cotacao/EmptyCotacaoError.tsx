...
const ThemeAwareLogo = () => {
  return (
    <>
      ...
      <img src={LogoDark} alt="logo polar fix" className="px-18 mb-1 dark:hidden" />
...
export default function EmptyCotacaoError({
  alertMessage = "Não foram encontrados cotações.",
  onRetry,
  onBack,
  showBackButton = true,
}: EmptyCotacaoErrorProps) {
  return (
      ...
      <Card className="w-full max-w-md shadow-lg border-none">
        ...
        <CardContent>
          ...
          <div className="text-center mt-6 text-slate-600">
            <p>
              Verifique se você tem acesso as cotações ou se existem
              cotações cadastrados no sistema.
            </p>
          </div>
        </CardContent>
