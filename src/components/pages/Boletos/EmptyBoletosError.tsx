...
export default function EmptyBoletosError({
  alertMessage = "Não foram encontrados boletos.",
  onRetry,
  onBack,
  showBackButton = true,
}: EmptyBoletosErrorProps) {
  return (
      ...
      <Card className="w-full max-w-md shadow-lg border-none">
        ...
        <CardContent>
          ...
          <div className="text-center mt-6 text-slate-600">
            <p>
              Verifique se você tem acesso aos boletos ou se existem boletos
